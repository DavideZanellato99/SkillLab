                        ...
                        <div className="min-w-0 flex-1">
                          {isRenaming ? (
                            ...
                            <div className="flex flex-wrap items-center gap-2">
                              ...
                              <span className="inline-flex shrink-0 items-center gap-1 rounded-full border border-white/6 bg-white/5 px-2 py-0.5 text-[0.62rem] font-semibold uppercase tracking-wider text-slate-400">
                                {conv.mode === 'text' ? (
                                  <>
