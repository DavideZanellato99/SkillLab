 ...
 *
 * Sta accanto al badge perché è la stessa cosa detta due volte, una per
 * leggere e una per filtrare, e due elenchi separati finirebbero per offrire
 * scelte diverse nelle due schermate. Il default invece non sta qui: la
 * dashboard parte dalle chiamate perché una media che mescola i due canali è
 * ambigua, il report da entrambe perché lì si guarda cosa una persona ha
 * fatto e nasconderne metà sarebbe una risposta incompleta. */
 ...
 * readers, and the tooltip spells the channel out either way.
 */
export default function ConversationModeBadge({
  ...
  return (
    <Tooltip content={isText ? 'Conversazione scritta in chat' : 'Conversazione al telefono'}>
      <span
