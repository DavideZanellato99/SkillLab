...
export default function Header({ totalAvatars, totalSelections, totalCategories }: HeaderProps) {
  return (
      ...
      <div className="relative z-10">
        ...
        <div className="mb-8 mt-6 flex animate-fade-in-up justify-center gap-12 px-8 py-6 [animation-delay:0.4s] max-md:gap-6">
          ...
          <div className="text-center">
            ...
            <div className={statLabelCls}>Selezioni</div>
          </div>
          <div className="text-center">
