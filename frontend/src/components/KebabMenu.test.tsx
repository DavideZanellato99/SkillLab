...
function voci(over: Partial<KebabMenuItem>[] = []): KebabMenuItem[] {
  const base: KebabMenuItem[] = [
    { key: 'sospendi', label: 'Sospendi account', onSelect: vi.fn() },
    { key: 'disabilita', label: 'Disabilita account', onSelect: vi.fn() },
    { key: 'rinvia', label: 'Rinvia credenziali', onSelect: vi.fn() },
  ]
