          ...
          <table className="w-full border-collapse text-left">
            <thead>
              <tr>
                ...
                <th className={`${thCls} text-right`}>Durata Totale</th>
                <th className={thCls} aria-label="Dettaglio" />
              </tr>
            </thead>
            <tbody>
              {report.length === 0 ? (
                ...
                report.map((u) => {
                  ...
                  return (
                    <Fragment key={u.id}>
                      <tr
                        className={`cursor-pointer transition ${isExpanded ? '[&>td]:bg-violet-600/6' : 'hover:[&>td]:bg-white/4'}`}
                      ...
                      {isExpanded && (
                        <tr>
                          <td colSpan={6} className="border-b border-white/6 bg-gray-950/40 px-6 py-4">
