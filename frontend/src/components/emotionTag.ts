 ...
 * viene separato dal testo e tradotto in italiano; a mostrarlo come badge
 * "Tono di voce" sotto il messaggio pensa `MessageEmotions`.
 *
 * La lettura sta in un file a parte perché serve prima del badge: la bolla
 * della chat e il dettaglio conversazione devono sapere dove finisce il testo
 * del messaggio anche quando di emozioni non ce ne sono. */
